...
class StructuredWebUiTests(unittest.TestCase):
    ...
    def test_one_click_registration_and_card_link_is_a_separate_pipeline_module(self):
        ...
        self.assertIn('data-catchall-domain="llhdsczy.com">llhdsczy.com · 本地归档接码</option>', page)
        ...
        self.assertIn(
            "use_secondary_proxy: !config.promotionProxyChoice && !singleProxy",
            page,
        )
        self.assertIn(
    ...
    def test_one_click_pipeline_skips_only_an_existing_generated_paypal_link(self):
        ...
        self.assertIn('promotionProxyChoice: "second"', page)
        self.assertIn('fixedTargetAmount: "0"', page)
